    ...
    <body>
        <div class="container d-flex justify-content-center">
            <div id="main-content" class="rounded p-3 mt-5">
                ...
                <p>Dog No :
                    <span id="dogno"><% out.println(request.getParameter("dogno")); %></span>
                </p>
                <p>PHONE NUMBER :
                    <span id="phoneno"><% out.println(request.getParameter("phoneno")); %></span>
                </p>
                <p>ORDERED DETAILS :
                    <span id="oredrdetails"><% out.println(request.getParameter("address")); %></span>
                </p>
               


                <p class="text-center">HAPPY CUSTOMER !!!</p>
                <button onclick="saveDetails()">OK</button>
            </div>
        </div>
